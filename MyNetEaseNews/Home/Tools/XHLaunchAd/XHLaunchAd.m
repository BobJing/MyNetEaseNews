...
-(UIImageView *)launchImgView
{
    if(_launchImgView==nil)
    {
        ...
        _launchImgView = [[UIImageView alloc] initWithFrame:CGRectMake(0, [UIScreen mainScreen].bounds.size.height - 120, [UIScreen mainScreen].bounds.size.width, 120)];
        _launchImgView.contentMode = UIViewContentModeScaleAspectFit;
        _launchImgView.image = [UIImage imageNamed:@"about_hd"];
    }
