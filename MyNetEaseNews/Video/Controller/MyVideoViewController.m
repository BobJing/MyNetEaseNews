...
@interface MyVideoViewController ()<UITableViewDelegate,UITableViewDataSource,UIScrollViewDelegate,WMPlayerDelegate>
{
...
- (void)onDeviceOrientationChange{
    if (wmPlayer==nil||wmPlayer.superview==nil||self.tabBarController.selectedViewController != self){
        return;
    }
...
{
    if (!_table) {
        _table = [[UITableView alloc]initWithFrame:CGRectMake(0, 64, kScreenWidth, kScreenHeight-64-49)];
